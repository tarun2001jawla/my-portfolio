...
import { FaTwitter, FaInstagram, FaPinterest, FaFacebookSquare, FaStar, FaArrowLeft, FaArrowRight } from 'react-icons/fa';
...
const Reviews:Review[] = [
  {
    ...
    platform: 'instagram',
    review: 'Their web design service is top-notch! The team was creative, and they delivered beyond my expectations. Highly recommended for anyone looking to build a stunning website.',
    rating: 5,
    date: 'May 23, 2023',
  },
  {
    ...
    platform: 'twitter',
    review: 'I hired them for my app development project, and I must say, I\'m impressed! The app they built is sleek, user-friendly, and bug-free. Great job, team!',
    rating: 4.5,
    date: 'May 20, 2023',
  },
  {
    ...
    platform: 'pinterest',
    review: 'Their graphic design skills are exceptional! They transformed my ideas into visually stunning graphics. I couldn\'t be happier with the results. Thank you!',
    rating: 5,
    date: 'May 18, 2023',
  },
  {
    ...
    platform: 'facebook',
    review: 'They helped me set up my e-commerce website, and the results are outstanding! My online store looks professional, and I\'ve seen a significant increase in sales. Highly recommend their services!',
    rating: 5,
    date: 'May 15, 2023',
  },
  {
    ...
    <Box mt={10}>
      ...
      <div className="glide" ref={glideRef}>
            ...
            {Reviews.map((review, index) => (
              <li className="glide__slide" key={index}>
                <Box
                  ...
                  bg={review.platform === 'twitter' ? 'rgba(29, 161, 242, 0.2)' : review.platform === 'instagram' ? 'rgba(193, 53, 132, 0.2)' : review.platform === 'pinterest' ? 'rgba(203, 32, 39, 0.2)' : 'rgba(66, 103, 178, 0.2)'}
                  ...
                  <Flex alignItems="center" mb={4}>
                    ...
                    <Box>
                      <Flex alignItems="center" mb={2}>
                        ...
                        <Box className="review-platform" display="flex" alignItems="center">
        ...
        <div className="glide__arrows" data-glide-el="controls">
          <button className="glide__arrow glide__arrow--left" data-glide-dir="<"><FaArrowLeft /></button>
          <button className="glide__arrow glide__arrow--right" data-glide-dir=">"><FaArrowRight /></button>
        </div>
      </div>
    </Box>
  );
